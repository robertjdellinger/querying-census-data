...
We obtained demographic, housing, and income data from the 2016–2020 American Community Survey (ACS) 5-Year Estimates at the block group level for Los Angeles County, California using the tidycensus R package (Walker, 2023). Data were accessed via the U.S. Census API, and spatial geometries were downloaded directly using the geometry = TRUE argument, leveraging TIGER/Line shapefiles via the tigris package.
